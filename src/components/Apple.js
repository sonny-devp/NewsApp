...
const Apple = () => {
    ...
    const fetchData = async () => {
        const data = await fetch('http://newsapi.org/v2/everything?q=apple&from=2020-12-14&to=2020-12-14&sortBy=popularity&apiKey=cfb4eb681a8f4f109da17eb4f5348f79')
    ...
    return(
        <div>
            ...
            <h3 className= "display-3 text-center text-light">APPLE NEWS</h3>
